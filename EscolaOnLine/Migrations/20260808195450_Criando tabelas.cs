    ...
    public partial class Criandotabelas : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enrollaments", x => new { x.CourseId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_Enrollaments_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Enrollaments_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_Categoria",
                table: "Courses",
                column: "Categoria");

            migrationBuilder.CreateIndex(
                name: "IX_Enrollaments_StudentId",
                table: "Enrollaments",
                column: "StudentId");
